  ...
  const content = {
    fr: {
      ...
      sections: [
        ...
        { title: '7. Suspension et suppression', content: "TeamUpFR se réserve le droit de suspendre ou supprimer tout compte qui viole les présentes conditions, sans préavis. Les utilisateurs peuvent supprimer leur compte à tout moment depuis leur profil ou en contactant teamupfr.ch@gmail.com." },
    ...
    de: {
      ...
      sections: [
        ...
        { title: '7. Sperrung und Löschung', content: "TeamUpFR behält sich das Recht vor, Konten die gegen diese Bedingungen verstossen ohne Vorankündigung zu sperren oder zu löschen. Benutzer können ihr Konto jederzeit über ihr Profil oder per E-Mail an teamupfr.ch@gmail.com löschen." },
